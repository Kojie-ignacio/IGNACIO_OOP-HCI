            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Dashboard</h1>
                    ...
                    if(isset($_POST['update'])){
                       ...
                       $query  = "update users_tbl set firstname = '$fname', lastname = '$lname', email = '$email', address = '$address' where id='$user_id'";
